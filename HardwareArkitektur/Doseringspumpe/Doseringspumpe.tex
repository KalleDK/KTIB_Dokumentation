...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.4]{../Hardware/Doseringspumpe/Screenshots/UdregningAfAfsatEffektIdoseringspumpe}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.4]{../Hardware/Doseringspumpe/Screenshots/BeregningInternModstandDoseringspumpe}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.5]{../Hardware/Doseringspumpe/Screenshots/DatabladTilUdregningMOSFET}
...
\begin{figure}[!h]
	\centering
	\includegraphics[scale=0.5]{../Hardware/Doseringspumpe/Screenshots/UdregningAfsatEffektMOSFETkreds}
...
\begin{figure}[!h]
	\centering
	\includegraphics[height=6cm]{../Hardware/Doseringspumpe/Screenshots/DoseringspumpeStyringskredslob}
