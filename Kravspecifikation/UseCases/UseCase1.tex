...
Når bruger ønsker at aflæse målingerne, skal data aflæses via \glslink{gui}{gui'en}. Denne use case kan kun gennemføres af en person da der kun er en \gls{gui}. 
